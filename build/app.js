...
/***/ function(module, exports, __webpack_require__) {
	...
	var Checkout = __webpack_require__(/*! ./Checkout */ 184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1);
	var data = __webpack_require__(/*! ../data */ 160);
	...
	var Product = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (data.cartItems.hasOwnProperty(this.props.product.id)) {
	            add = React.createElement(QuantityControl, { item: data.cartItems[this.props.product.id], variant: "gray" });
	        }
	...
	var Products = React.createClass({
	    ...
	    render: function render() {
	        ...
	        for (var id in data.products) {
	            children.push(React.createElement(Product, { key: data.products[id].id, product: data.products[id] }));
	        }
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("img", { src: data.products[id].imagePath })
	                ),
	                React.createElement(
	                    "div",
	...
	var Cart = React.createClass({
	    ...
	    render: function render() {
	        var children = [];
	        for (var id in data.cartItems) {
	            children.push(React.createElement(CartItem, { key: data.cartItems[id].id, cartItem: data.cartItems[id] }));
	        }
